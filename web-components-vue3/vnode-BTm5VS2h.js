...
import { e } from "./base-KIYEtT4d.js";
...
const A = (E) => {
  ...
  return N.forEach((T) => {
    var r;
    e(T) ? S.push(...A(T)) : o(T) && e(T.children) ? S.push(...A(T.children)) : (S.push(T), o(T) && ((r = T.component) != null && r.subTree) && S.push(...A(T.component.subTree)));
  }), S;
};
export {
  _ as P,
